...
from src.ip_adapter.attention_processor import SparseCausalAttentionProcessor
...
class Attention(nn.Module):
    ...
    def set_use_memory_efficient_attention_xformers(
        ...
        is_sparse_causal_attention = hasattr(self, "processor") and isinstance(
            self.processor,
            (
                SparseCausalAttentionProcessor,
            ),
        )
        ...
        if use_memory_efficient_attention_xformers:
            ...
            elif is_sparse_causal_attention:
